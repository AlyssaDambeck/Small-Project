...
const urlBase = 'http://134.209.166.2/LAMPAPI';
const extension = 'php';
...
function doLogin()
{
	...
	// ✅ FIXED: Send plain password (matching database storage)
...
function doSignup()
{
	...
	// ✅ FIXED: Removed MD5 hashing - store plain password
	// var hash = md5(password); // ❌ REMOVED THIS LINE
	document.getElementById("signupResult").innerHTML = "";

	// ✅ FIXED: Use plain password instead of hash
